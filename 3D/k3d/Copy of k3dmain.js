...
function init()
{
   ...
   var k3dmain6 = new K3D.Controller(canvas6);
   ...
   // my own try
      ...
      with (obj)
      {
         ...
         scale = 100;
         init(
            [{x:-2,y:2,z:-2}, {x:1,y:1,z:-1}, {x:1,y:-1,z:-1}, {x:-1,y:-1,z:-1}, {x:-1,y:1,z:1}, {x:1,y:1,z:1}, {x:0,y:-0,z:1}, {x:-1,y:-1,z:0}],
            [{a:0,b:1}, {a:1,b:2}, {a:2,b:3}, {a:3,b:0}, {a:4,b:5}, {a:5,b:6}, {a:6,b:7}, {a:7,b:4}, {a:0,b:4}, {a:1,b:5}, {a:2,b:6}, {a:3,b:7}],
